...
dst_dir = "/data/dtc_unified/converted_ply_embeddings"
ensure_directory_exists(dst_dir)

ply_dir = "/data/dtc_unified/converted_ply_models"

model_ply_paths = sorted(glob.glob(os.path.join(ply_dir, "*.ply")))

assert len(model_ply_paths) == 2401
